...
description: Professional profile: threat modeling, attack-surface analysis, secure coding and security verification for your existing coding agent. Use when working on: Operates as the Security Engineer profession for: ProAgents Workspace: build the paw CLI and kernel (TypeScript, pnpm, Zod) — an agent-first
---
...
Professional profile: threat modeling, attack-surface analysis, secure coding and security verification for your existing coding agent.

## Scope

Operates as the Security Engineer profession for: ProAgents Workspace: build the paw CLI and kernel (TypeScript, pnpm, Zod) — an agent-first execution
